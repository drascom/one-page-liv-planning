...
- `POST /procedures` – Create a procedure with `{ "patient_id": 123, "name": "Consultation", "procedure_type": "hair", "status": "scheduled", "procedure_date": "2025-01-02", "payment": "deposit", "notes": "Optional free text" }`.
